...
public class GetItemsHandler extends HandlerPrototype implements HttpHandler {
    ...
    private JSONObject getItemDataByCompany(String cid){
        ...
        String getItemDataSql = "SELECT table_items.mid, table_items.name, table_items.category, table_itempalletmapping.mlot FROM table_items LEFT JOIN table_itempalletmapping ON table_items.mid = table_itempalletmapping.mid AND table_items.cid = ?";
